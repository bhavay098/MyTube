    ...
    <Layout>
      <div className="animate-fade-in space-y-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Link
            to="/upload"
            className="inline-flex items-center gap-2 rounded-2xl bg-(--accent) px-5 py-2.5 text-xs font-bold text-white transition-all hover:bg-(--accent-strong) shadow-md shadow-(--accent-soft)"
          >
            <Play size={14} />
        ...
        <section className="rounded-3xl border border-(--border) bg-(--surface) p-6 shadow-(--shadow-sm)">
          <div className="mb-5 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <h2 className="text-lg font-bold text-(--text)">Uploaded Content ({videos.length})</h2>
            </div>
          </div>
                    ...
                    >
                      <td className="py-3.5 pr-4">
                        ...
                        >
                          ...
                          <span className="line-clamp-1 max-w-xs text-sm font-semibold text-(--text) group-hover:text-(--accent) transition-colors">
                            {video.title}
                          </span>
                        </Link>
                      </td>
                      ...
                      <td className="py-3.5 text-right">
                        <Link
                          to={`/video/${video._id}`}
                          className="inline-flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-semibold text-(--muted) hover:bg-(--surface-2) hover:text-(--accent)"
                        >

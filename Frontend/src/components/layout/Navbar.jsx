      ...
      <div className="mx-auto flex h-16 w-full max-w-400 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-(--border) bg-(--surface) text-(--text) transition-colors duration-200 hover:-translate-y-0.5 hover:border-(--border-strong) hover:bg-(--surface-2) md:hidden"
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {!isAuthenticated ? (
            <>
              <Link
                to="/login"
                className="hidden rounded-full border border-(--border) px-3 py-2 text-sm font-medium text-(--text) transition-colors duration-200 hover:-translate-y-0.5 hover:border-(--border-strong) hover:bg-(--surface-2) sm:inline-flex sm:px-5"
              >
                Log in
              </Link>
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-(--border) py-1 pl-1 pr-3 transition-colors duration-200 hover:border-(--border-strong) hover:bg-(--surface-2)"
              >
                <img
                  src={user?.avatar}
                  alt={user?.username}
